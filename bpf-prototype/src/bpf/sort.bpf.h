 ...
 *
 * TODO: convert this into a function generated by the BpfProgramBuilder, where
 * macros are replaced by always inline functions with the specific type.
 */

#include "common.bpf.h"

// Performs insertion sort on arr (with the specified arr_sz, type, and member
// to compare).
//
// This is a macro rather than a function, since type and member are C symbols,
// rather than actual variables.
...
//
// Like above, this is a macro rather than a function, since type and member are
// C symbols.
